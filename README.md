...
|UI_CHAT_DESCRIPTION|No|This chatbot is configured to answer your questions related to application modernisation for Contoso| Description (chat window)
  ...
  "mcp": {
    "servers": {
      "architect-copilot": {
        ...
        "args": [
          "C:\\Path\\To\\Architect-Copilot\\server.py"
        ],
        "env": {
          "PYTHONUNBUFFERED": "1"
        }
